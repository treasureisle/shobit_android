...
public class UserViewHolder extends RecyclerView.ViewHolder {
    public static String TAG = UserViewHolder.class.getSimpleName();
    ...
    private void drawLayout(final Activity activity, final User user) {
    ...
    public void onBind(final Activity activity, final User user) {
        drawLayout(activity, user);
    }
}